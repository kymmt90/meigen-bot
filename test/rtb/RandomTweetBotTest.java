...
public class RandomTweetBotTest {
    public static class InitializeWithJsonSingle {
        ...
        public void nextTweet_returns_text_including_1() throws Exception {
            ...
            assertThat(actual, is("1 [user] [0 like] [1990-01-18 01:23] https://twitter.com/null/status/0000000000"));
        }
    ...
    public static class InitializeWithJsonMultiple {
        ...
        public void getTweet_0_returns_tweet_including_1() throws Exception {
            assertThat(sut.getTweet(0).toString(), is("1 [user] [0 like] [1990-01-18 01:23] https://twitter.com/null/status/0000000000"));
        }

        @Test
        public void getTweet_1_returns_tweet_including_2() throws Exception {
            assertThat(sut.getTweet(1).toString(), is("2 [user] [0 like] [1990-01-18 01:23] https://twitter.com/null/status/0000000000"));
        }
        ...
        public void nextTweet_retrns_tweet_including_1_or_2() throws Exception {
            ...
            for (int i = 0; i < 100; ++i) {
                if (sut.nextTweet().toString().equals("1 [user] [0 like] [1990-01-18 01:23] https://twitter.com/null/status/0000000000")) one = true;
                if (sut.nextTweet().toString().equals("2 [user] [0 like] [1990-01-18 01:23] https://twitter.com/null/status/0000000000")) two = true;
            }
        ...
        public void nextTweet_returns_tweet_which_is_different_from_prevTweet() throws Exception {
            sut.setPrevTweet(new Tweet("test", "1", "1990-01-18 01:23", 0, "https://twitter.com/null/status/0000000000"));
            String actual = sut.nextTweet().toString();
    ...
    public static class InitializeWithJsonReply {
        public static class ReplyConfIsTrue {
            ...
            public void nextTweet_returns_both_reply_and_not_reply_tweet() throws Exception {
                ...
                for (int i = 0; i < 100; ++i) {
                    if (sut.nextTweet().toString().equals("@test_user test [user] [0 like] [1990-01-18 01:23] https://twitter.com/null/status/0000000000")) reply = true;
                    if (sut.nextTweet().toString().equals(".@test_user test [user] [0 like] [1990-01-18 01:23] https://twitter.com/null/status/0000000000")) notReply = true;
                }
            ...
            public void allows_reply_tweet_returns_true() throws Exception {
                assertThat(sut.allows(new Tweet("test", "@test_user test", "1990-01-18 01:23", 0, "https://twitter.com/null/status/0000000000")), is(true));
            }
        }
        ...
        public static class ReplyConfIsFalse {
            ...
            public void allows_reply_tweet_returns_false() throws Exception {
                assertThat(sut.allows(new Tweet("test", "@test_user test", "1990-01-18 01:23", 0, "https://twitter.com/null/status/0000000000")), is(false));
            }
        }
    }
}
